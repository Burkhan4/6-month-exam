...
const ProductDetailPage = () => {
  ...
  return (
    <section className="">
      <div className="container hidden tablet:flex desktop:flex">
        <h2 className="desktop:text-[15px] tablet:text-[14px] text-[12px] font-bold mb-10.75">
          Home / <span className="font-normal">Shop</span> / {product.name}
        </h2>
      ...
      <div className="tablet:hidden desktop:hidden bg-[#F4F4F4] mb-50">
        <div className="container">
          <div className="pt-5.75 px-7.25">
            <div className="max-w-89 w-full h-89 m-auto relative">
              {/* Backenddan asosiy rasm (activeImageIndex orqali, desktop bilan bir xil) */}
              <img
                className="w-89 h-89"
                src={
